  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black">
      ...
      <video 
        ...
        poster="/images/videos/optimized/zebra-new-720p.mp4"
      >
        {/* Multiple sources for different screen sizes and device capabilities */}
        <source 
          src="/images/videos/optimized/zebra-new-1080p.mp4" 
          type="video/mp4" 
          media="(min-width: 1024px)"
        />
        <source 
          src="/images/videos/optimized/zebra-new-720p.mp4" 
          type="video/mp4" 
          media="(min-width: 768px)"
        />
        <source 
          src="/images/videos/optimized/zebra-new-480p.mp4" 
          type="video/mp4"
        />
